    ...
    <div className="dashboard-container">
      ...
      <main className="dashboard-content">
        ...
        <div className="summary-cards-grid">
          <div className="card assistencias-card"> {/* Clase agregada */}
          ...
          <div className="card ausentes-card"> {/* Clase agregada */}
            <div className="card-icon">
              <svg xmlns="http://www.w3.org/2000/svg" height="48px" viewBox="0 -960 960 960" width="48px"> {/* fill se hereda del CSS */}
          ...
          <div className="card justificaciones-card"> {/* Clase agregada */}
            <div className="card-icon">
              <svg xmlns="http://www.w3.org/2000/svg" height="48px" viewBox="0 -960 960 960" width="48px"> {/* fill se hereda del CSS */}
          ...
          <div className="card sin-justificar-card"> {/* Clase agregada */}
            <div className="card-icon">
              <svg xmlns="http://www.w3.org/2000/svg" height="48px" viewBox="0 -960 960 960" width="48px"> {/* fill se hereda del CSS */}
